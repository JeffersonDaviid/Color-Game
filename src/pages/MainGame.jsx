...
function MainGame() {
  ...
  const [selectedColor, setSelectedColor] = useState('lightgray'); // Valor inicial válido
  const [selectedLabel, setSelectedLabel] = useState(''); // Valor inicial válido
  ...
  const handleColorSelection = (colorObj) => {
    setSelectedColor(colorObj.color || 'lightgray'); // Fallback si es null
    setSelectedLabel(colorObj.label || ''); // Fallback si es null
  ...
  const handleClearSelection = () => {
    setSelectedColor('lightgray'); // Valor válido
    setSelectedLabel(''); // Valor válido
  };
      ...
      <div className='game-layout'>
        <div
          ...
          {selectedTangrams.map((TangramComponent, index) => (
            <TangramComponent
              key={index}
              selectedColor={selectedColor || 'lightgray'} // Fallback si es null
              selectedLabel={selectedLabel || ''} // Fallback si es null
              letters={LABELS}
